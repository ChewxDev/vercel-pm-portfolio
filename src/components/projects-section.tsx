...
export default function ProjectsSection() {
  ...
  const getColorClasses = (color: string) => {
    switch (color) {
      ...
      case "purple":
        return "border-l-8 border-purple-600";
      case "orange":
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="space-y-16">
          {projects.map((project) => (
            <div
              key={project.id}
              className={`bg-white rounded-lg shadow-lg overflow-hidden ${getColorClasses(
                project.color
              )}`}
            >
              <div className="p-8">
                ...
                <p className="text-gray-600 mb-4">
                  ...
                  {project.company || project.client || "N/A"}
                </p>
                ...
                <div className="text-sm text-gray-500 mb-6">
                  ...
                  <span className="mr-4">
                    ...
                    {project.teamSize || project.team_size || "N/A"}
                  </span>
                  <span>
